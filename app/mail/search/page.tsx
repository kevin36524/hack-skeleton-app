...
function SearchPageContent() {
  ...
  const renderMessageItem = (message: SearchResultMessage) => {
    ...
    return (
      <div
        ...
        className={cn(
          ...
          isSelected ? 'bg-purple-100 dark:bg-purple-900/40 border-l-4 border-l-purple-600 border-purple-300 dark:border-purple-700' : ''
        )}
              ...
              {!hasSearched ? (
                ...
                <ScrollArea className="h-full">
                  <div className="p-2 space-y-1">
                    ...
                    {searchResults.map(renderMessageItem)}
                  </div>
                </ScrollArea>
              )}
            </div>
