...
export function FolderSidebar({
  ...
  const loadFolders = async () => {
    try {
      setLoading(true);
      console.log('FolderSidebar: Calling folderService.getFolders for mailboxId:', mailboxId, 'accountId:', accountId);
      ...
      let filteredFolders = foldersData.folders;
      if (accountId) {
        filteredFolders = foldersData.folders.filter(folder => folder.acctId === accountId);
        console.log('FolderSidebar: Filtered to', filteredFolders.length, 'folders for account:', accountId);
      }
